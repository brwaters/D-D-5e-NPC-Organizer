...
class PropertyKey {
    static let image = "characterImage"
    static let name = "characterName"
    static let description = "characterDescription"
...
class CharacterItem: NSObject, NSCoding {
    ...
    var lairActions: String
    
    
    override convenience init() {
            self.init(image: #imageLiteral(resourceName: "Character Silhouette"), name: "Strahd Von Zarovich", description: "Medium Undead")
        }
    ...
    required convenience init?(coder aDecoder: NSCoder) {
        ...
        guard let description = aDecoder.decodeObject(forKey: PropertyKey.description) as? String
            else {
            os_log("Missing description", log: OSLog.default, type: .debug)
            return nil
        }
        self.init(image: image, name: name, description: description)
    }
    
    func encode(with aCoder: NSCoder) {
        aCoder.encode(image, forKey: PropertyKey.image)
        aCoder.encode(name, forKey: PropertyKey.name)
        aCoder.encode(characterDescription, forKey: PropertyKey.description)
    }
